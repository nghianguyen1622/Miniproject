...
import com.nghiait.test.nghiait.test.service.IStorageService;

@Controller
@RequestMapping(path = "/api/v1/FileUpLoad")
public class FileUploadController {
	// controller upload file, image from client
	...
	public ResponseEntity<ResponseObject> getUploadedFiles(){
		try {
			...
			return ResponseEntity.ok(new ResponseObject("ok", "List files successfuly", urls));
		} catch (Exception e) {
